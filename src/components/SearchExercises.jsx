...
const SearchExercises = ({ setExercises, bodyPart, setBodyPart }) => {
  ...
  return (
    <Stack alignItems='center' justifyContent='center' p='20px' mt='37px'>
      ...
      }} textTransform='capitalize' textAlign='center' mb='50px'>
      ...
      <Box position='relative' mb='72px'>
        ...
        }} height='76px' placeholder='Search Exercises' type='text' value={search} onChange={(e) => setSearch(e.target.value.toLowerCase())} />
        <Button className="search-btn" sx={{
          position: 'absolute', right: '0', fontSize: { lg: '20px', xs: '14px' }, color: '#fff', textTransform: 'none', width: { lg: '175px', xs: '80px' },  height: '56px', bgcolor: '#ff2625'
